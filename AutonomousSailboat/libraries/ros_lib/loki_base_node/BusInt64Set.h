#ifndef _ROS_SERVICE_BusInt64Set_h
#define _ROS_SERVICE_BusInt64Set_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char BUSINT64SET[] = "loki_base_node/BusInt64Set";

  class BusInt64SetRequest : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return BUSINT64SET; };
    const char * getMD5(){ return "52f5f8cab88c8cb1ec967b2827465f8e"; };

  };

  class BusInt64SetResponse : public ros::Msg
  {
    public:
  ...
  class BusInt64Set {
    public:
    typedef BusInt64SetRequest Request;
    typedef BusInt64SetResponse Response;
  };
