#ifndef _ROS_SERVICE_BusUInt64Set_h
#define _ROS_SERVICE_BusUInt64Set_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char BUSUINT64SET[] = "loki_base_node/BusUInt64Set";

  class BusUInt64SetRequest : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return BUSUINT64SET; };
    const char * getMD5(){ return "d048b3ad41380df4c201d35c6210a48b"; };

  };

  class BusUInt64SetResponse : public ros::Msg
  {
    public:
      typedef int8_t _status_type;
      _status_type status;

    BusUInt64SetResponse():
      status(0)
    {
    }
  ...
  class BusUInt64Set {
    public:
    typedef BusUInt64SetRequest Request;
    typedef BusUInt64SetResponse Response;
  };
