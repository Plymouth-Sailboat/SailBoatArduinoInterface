#ifndef _ROS_SERVICE_BusInt8Set_h
#define _ROS_SERVICE_BusInt8Set_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char BUSINT8SET[] = "loki_base_node/BusInt8Set";

  class BusInt8SetRequest : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return BUSINT8SET; };
    const char * getMD5(){ return "e2f35946c11e5c92a0d0a798c2e9453c"; };

  };

  class BusInt8SetResponse : public ros::Msg
  {
    public:
  ...
  class BusInt8Set {
    public:
    typedef BusInt8SetRequest Request;
    typedef BusInt8SetResponse Response;
  };
