#ifndef _ROS_SERVICE_BusUInt16Get_h
#define _ROS_SERVICE_BusUInt16Get_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char BUSUINT16GET[] = "loki_base_node/BusUInt16Get";

  class BusUInt16GetRequest : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return BUSUINT16GET; };
    const char * getMD5(){ return "8f34dd8065292bfe7f0cd82f981e1007"; };

  };

  class BusUInt16GetResponse : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return BUSUINT16GET; };
    const char * getMD5(){ return "bcdfe955cb1df23b94010857287a43a3"; };

  };

  class BusUInt16Get {
    public:
    typedef BusUInt16GetRequest Request;
    typedef BusUInt16GetResponse Response;
  };
