#ifndef _ROS_tf2_web_republisher_TFArray_h
#define _ROS_tf2_web_republisher_TFArray_h
...
namespace tf2_web_republisher
{
  ...
  class TFArray : public ros::Msg
  {
    ...
    const char * getType(){ return "tf2_web_republisher/TFArray"; };
