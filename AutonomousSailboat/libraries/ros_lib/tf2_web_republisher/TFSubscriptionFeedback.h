#ifndef _ROS_tf2_web_republisher_TFSubscriptionFeedback_h
#define _ROS_tf2_web_republisher_TFSubscriptionFeedback_h
...
namespace tf2_web_republisher
{
  ...
  class TFSubscriptionFeedback : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "tf2_web_republisher/TFSubscriptionFeedback"; };
