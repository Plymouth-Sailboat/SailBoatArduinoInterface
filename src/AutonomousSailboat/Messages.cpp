...
// Serial port:
  ...
  const int SERIAL_BAUD = 9600;  // 9600 is not advised if we want to see GPS data in the serial port and must be < 115200
#endif
...
SdVolume SDvolume;
  ...
  String SDFileName = "", //"LOG_000";  // empty string to activate automatic naming otherwise, put a name <= 8 characters
